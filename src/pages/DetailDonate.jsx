...
function DetailDonate(props) {
	const { showModal, toggleModal } = useContext(showContext);
	return (
		<>
			<Container fluid='sm' className='my-md-4'>
				...
				<Row>
					...
					<Col md={4} sm={12} className='my-md-5'>
						<Row>
							<Col md={12} className=''>
								<h3 className='fw-bold text-black'>The Strength of a People. Power of Community</h3>
							</Col>
							...
							<Col md={12} className='d-flex justify-content-center'>
								<Button onClick={toggleModal} className='w-100' style={{ borderRadius: 10 }}>
									Donate
								</Button>
							</Col>
						</Row>
